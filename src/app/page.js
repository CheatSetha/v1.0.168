        ...
        >
            ...
            >
                ...
                <Image
                    ...
                    width={586}
                    height={484}
                    className='top-5 md:w-[300px] max-sm:w-[200px] max-sm:h-[200px] max-md:h-[300px] max-md:w-[300px] md:h-[300px] md:pt-2'
                />
            </section>
            <section
                class={
            ...
            >
                ...
                <div className='flex gap-5  justify-between pb-7 max-sm:flex-col'>
                    ...
                    <div className='lg:w-1/2 w-[90%] p-10 bg-[#e9e8e8] rounded-[26px] max-sm:w-full max-sm:p-4'>
                        ...
                        <p className='py-10 text-[#333] max-sm:pt-[15px] max-sm:text-[12px] max-sm:pb-[20px] '>
                            Watermark photos right in your browser. Add custom ​​watermarks with your logo and text.
                            Make multi-part watermarks. Add transparent and opaque watermarks
                            {showMore_one ? (
                                <>
                                    .Resize photos before publishing online. Import photos from your computer, Google
                                    Drive or Dropbox. Instant uploads and downloads. Watermark pictures without waiting
                ...
                <div className='flex justify-between max-sm:flex-col-reverse'>
                    <div className='w-[49%] p-10 bg-[#e9e8e8]  rounded-[26px] max-sm:w-full max-sm:p-4'>
                        ...
                        <p className='py-10 text-[#333] max-sm:pt-[15px] max-sm:text-[12px] max-sm:pb-[20px]'>
                            Start by designing a certificate template that includes relevant information such as the
                            recipient name, the title of the certificate, the issuing organization name and logo
                            {showMore ? (
                                <>
                                    , a description of the achievement, and any additional details you want to include.
                                    This template can be created using graphic design software or online certificate
                                    design tools.
                                </>
                            ) : (
                                <span id='dots'>...</span>
            ...
            <section class={lightBackground + darkBACKGROUND + "xl:w-[1290px] mt-20 lg:mt-32 "}>
                ...
                <div className='w-[90%] space-y-5 mx-auto'>
                    ...
                    >
                        <div className={lightBackground + darkBACKGROUND + " collapse-title  font-medium "}>
                            <p className="text-[#222] dark:text-[#fff]">CAN I USE MY OWN CUSTOM IMAGE OR LOGO AS A
                                WATERMARK ?</p>
                        </div>
            ...
            {/* tutuorial req */}
            <section className="mt-20 lg:mt-[128px]">
