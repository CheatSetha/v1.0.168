        ...
        <div className='dark:bg-black  '>
            ...
            <div className='flex pt-10 px-5 justify-between flex-wrap mx-auto w-full xl:w-[1290px] '>
                ...
                <div className='title-about w-[90%]   mb-5 space-y-3 md:space-y-6 lg:space-y-12 md:w-1/2'>
                    ...
                    <p className=' lg:text-[20px] max-sm:line-clamp-3  text md:text-[16px] dark:text-white '>
                        ...
                        love identity with our customization watermarks and <br/> certificates.
                    </p>
                </div>
                {/* image of about */}
                <div
            ...
            <main className='mt-32 xl:w-[1290px] w-full px-5 mx-auto '>
                ...
                <article className='text-center w-full p-2.5'>
                    <h1 className='title-about-3 text-[36px] font-black mb-8 dark:text-white'>WHO WE ARE</h1>
                    <p className='para-2 text-center text-[17px] dark:text-white'>
                        PhotoStad is one of the final project that was build by a group of ISTAD student.Photostad is a
                        cutting-edge print shop that offers <br/>
                        a state-of-the-art watermark maker,enabling photographers to protect their valuable images from
                        unauthorized use.Additionally<br/>
                        Photostad provides a powerful certificate generator,allowing professionals to create authentic
                        certificates for their artwork and <br/>
                ...
                {/* title meet out team */}
                <div className='mt-32 '>
                    <h1 className='title-about-4 text-[36px] font-black text-center dark:text-white'>MEET OUR TEAM</h1>
                ...
                <div>
                    <div className="mt-24  w-full mx-auto ">
                        {/* cart-1 */}
                        <div
                            className="mt-[90px] md:flex flex-col md:space-x-5 md:flex-row  lg:flex-row">
                            ...
                            <div
                                ...
                                <div
                                    className=" max-sm:shadow-md max-sm:overflow-hidden max-sm:max-w-2xl rounded-xl p-8">
                                    <h1 className=" tracking-wide font-bold dark:text-white text-[23px] mb-2">Chea
                                        Chento</h1>
                                    <p className="block mt-1  leading-tight font-light text-black dark:text-white text-[17px] mb-2">Back-End
                                        Developer</p>
                                    <div className='mt-4'>
                                        <div
                                            className=" bg-red-500 hover:bg-red-800 px-24 h-2 w-2 rounded-md mb-2"></div>
                                    </div>
                                    <div className='flex mt-4 '>
                                        <span
                                            className='text-[30px] dark:text-white mr-5 md:text-[25px]'><BsFacebook/></span>
                                        <span
                                            className='text-[30px] dark:text-white  mr-5 md:text-[25px]'><BsGithub/> </span>
                                        <span className='text-[33px] dark:text-white  md:text-[25px]'><TbWorld/> </span>
                                    </div>
                        ...
                        {/* card-2 */}
                        <div
                            className='mt-[90px] md:flex flex-col md:space-x-5 md:flex-row  lg:flex-row-reverse '>
                            <div className="flex max-sm:justify-center max-sm:m-auto ">
                                <img
                                    className="lg:w-[277px] lg:h-[277px] md:w-[270px] md:h-[250px] max-sm:w-[250px] max-sm:h-[250px]  object-cover  rounded-full  "
                            ...
                            <div
                                ...
                                <div
                                    className=" max-sm:shadow-md max-sm:overflow-hidden max-sm:max-w-2xl rounded-xl p-8">
                                    <h1 className=" tracking-wide   font-bold text-[23px] dark:text-white mb-2">Cheat
                                        Setha</h1>
                                    <p className="block mt-1  leading-tight font-light text-black dark:text-white text-[17px] mb-2"> Font-end
                                        Developer</p>
                                    <div className='mt-4'>
                                        <div
                                            className=" bg-red-500 hover:bg-red-800 px-24 h-2 w-2 rounded-md mb-2"></div>
                        ...
                        <div className='mt-[90px] md:space-x-5 md:flex ms:flex-col'>
                            ...
                            <div
                                ...
                                <div
                                    className=" max-sm:shadow-md max-sm:overflow-hidden max-sm:max-w-2xl rounded-xl p-8">
                                    <h1 className=" tracking-wide font-bold text-[23px] mb-2 dark:text-white">Bich
                                        Samrouth</h1>
                                    <p className="block mt-1  leading-tight font-light text-black  text-[17px] dark:text-white mb-2">Font-end
                                        Developer</p>
                                    <div className='mt-4'>
                                        <div
                                            className=" bg-red-500 hover:bg-red-800 px-24 h-2 w-2 rounded-md mb-2"></div>
                        ...
                        {/* card-4 */}
                        <div
                            className='mt-[90px] md:space-x-5 md:flex ms:flex-col lg:flex-row-reverse'>
                            <div className="flex max-sm:justify-center max-sm:m-auto ">
                                <img
                                    className="lg:w-[277px] lg:h-[277px] md:w-[270px] md:h-[250px] max-sm:w-[250px] max-sm:h-[250px]  object-cover  rounded-full  "
                                    src="/assets/image/RUPP.png" alt="Modern building architecture"/>
                            </div>
                            <div
                                className='max-sm:m-3 md:w-[70%] max-sm:flex max-sm:justify-center md:mx-auto md:rounded-l-none md:shadow-md md:max-w-2xl'>
                                <div
                                    className=" max-sm:shadow-md max-sm:overflow-hidden max-sm:max-w-2xl rounded-xl p-8">
                                    <h1 className=" tracking-wide font-bold text-[23px] dark:text-white mb-2">Piyan
                                        Kotrey</h1>
                                    <p className="block mt-1  leading-tight font-light text-black  text-[17px] dark:text-white mb-2">Back-End
                                        Developer</p>
                                    <div className='mt-4'>
                                        <div
                                            className=" bg-red-500 hover:bg-red-800 px-24 h-2 w-2 rounded-md mb-2"></div>
                                    ...
                                    <p className="mt-6 dark:text-white text-slate-500 md:mt-1">
                                        We build our computer systems the way we build our cities: over time, without a
                        ...
                        <div className='mt-[90px] md:space-x-5 md:flex ms:flex-col '>
                            ...
                            <div
                                ...
                                <div
                                    className=" max-sm:shadow-md max-sm:overflow-hidden max-sm:max-w-2xl rounded-xl p-8">
                                    <h1 className=" tracking-wide font-bold text-[23px] mb-2 dark:text-white">Sieng
                                        Pengny</h1>
                                    <p className="block mt-1  leading-tight font-light text-black  text-[17px] dark:text-white mb-2">Back-End
                                        Developer</p>
                                    <div className='mt-4'>
                        ...
                        <div
                            ...
                            <div
                                ...
                                <div
                                    className=" max-sm:shadow-md max-sm:overflow-hidden max-sm:max-w-2xl rounded-xl p-8">
                                    <h1 className=" tracking-wide font-bold text-[23px] dark:text-white mb-2">Yoeurn
                                        Sonita</h1>
                                    <p className="block mt-1  leading-tight font-light text-black dark:text-white text-[17px] mb-2"> Database
                                        Developer</p>
                                    <div className='mt-4'>
                                        <div
                                            className=" bg-red-500 hover:bg-red-800 px-24 h-2 w-2 rounded-md mb-2"></div>
                        ...
                        <div className='mt-[90px] md:space-x-5 md:flex ms:flex-col '>
                            ...
                            <div
                                ...
                                <div
                                    className=" max-sm:shadow-md max-sm:overflow-hidden max-sm:max-w-2xl rounded-xl p-8">
                                    <h1 className=" tracking-wide  font-bold text-[23px] dark:text-white mb-2">Vorn
                                        Saran</h1>
                                    <p className="block mt-1 leading-tight font-light text-black  text-[17px] dark:text-white mb-2">Back-End
                                        Developer</p>
                                    <div className='mt-4'>
                                    ...
                                    <p className="mt-6 dark:text-white text-slate-500 md:mt-1">
                                        Life is not about being rich, being popular, being highly educated
                                        or being perfect. it is about being real, humble, and kind.
                                    </p>
                                </div>
                            </div>
                        </div>
